...
namespace zelda2texteditor
{
    public partial class Form1 : Form
    {
        ...
        private void enableTextboxes() {
            zstoryeditTextBox.Enabled = true;
            zstoryeditTextBox2.Enabled = true;
            zstoryeditTextBox3.Enabled = true;
            zstoryeditTextBox4.Enabled = true;
            zstoryeditTextBox5.Enabled = true;
            zstoryeditTextBox6.Enabled = true;
            zstoryeditTextBox7.Enabled = true;
            zstoryeditTextBox8.Enabled = true;
            zstoryeditTextBox10.Enabled = true;
            zstoryeditTextBox11.Enabled = true;
            zstoryeditTextBox12.Enabled = true;
            zstoryeditTextBox13.Enabled = true;
            zstoryeditTextBox14.Enabled = true;
            zstoryeditTextBox15.Enabled = true;
            zstoryeditTextBox16.Enabled = true;
        }
